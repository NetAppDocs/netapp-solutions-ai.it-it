...
summary: 'NetApp ha tre portfolio di storage. FAS e AFF, E-Series e Cloud Volumes ONTAP. Abbiamo validato AFF e lo storage E-Series con il sistema storage ONTAP per soluzioni Hadoop con Apache Spark. La data fabric alimentata da NetApp integra servizi e applicazioni di gestione dei dati (building block) per l"accesso, il controllo, la protezione e la sicurezza dei dati.' 
---
