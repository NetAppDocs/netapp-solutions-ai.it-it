...
[role="lead"]
I tre script Python seguenti corrispondono ai tre principali casi d'uso testati.  Il primo è `sentiment_analysis_sparknlp.py` .
...
if __name__ == '__main__':
    ...
    spark.stop()
....
Il terzo copione è `run_classification_criteo_spark.py` .
