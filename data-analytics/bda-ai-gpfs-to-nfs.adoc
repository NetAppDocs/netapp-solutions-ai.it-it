...
summary: Questa sezione fornisce i passaggi dettagliati necessari per configurare GPFS e spostare i dati in NFS utilizzando NetApp XCP. 
---
= Passaggi dettagliati da GPFS a NFS
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Questa sezione fornisce i passaggi dettagliati necessari per configurare GPFS e spostare i dati in NFS utilizzando NetApp XCP.



== Configurare GPFS

. Scarica e installa Spectrum Scale Data Access per Linux su uno dei server.
+
....
...
…
....
. Installare il pacchetto prerequisito (inclusi chef e gli header del kernel) su tutti i nodi.
+
....
...
....
. Disabilitare SELinux in tutti i nodi.
+
....
...
[root@mastr-51 5.0.3.1]#
....
. Configurare il nodo di installazione.
+
....
...
[root@mastr-51 installer]#
....
. Aggiungere il nodo admin e il nodo GPFS al file di definizione del cluster.
+
....
...
[root@mastr-51 installer]#
....
. Aggiungere il nodo gestore e il nodo GPFS.
+
....
...
[root@mastr-51 installer]#
....
. Aggiungere il nodo quorum e il nodo GPFS.
+
....
...
[root@mastr-51 installer]#
....
. Aggiungere i server NSD e il nodo GPFS.
+
....
...
[root@mastr-51 installer]#
....
. Aggiungere i nodi GUI, admin e GPFS.
+
....
...
[root@mastr-51 installer]#
....
. Verificare ed elencare tutti i nodi.
+
....
...
[root@mastr-51 installer]#
....
. Specificare un nome per il cluster nel file di definizione del cluster.
+
....
...
....
. Specificare il binario della shell remota da utilizzare da GPFS; utilizzare `-r argument` .
+
....
...
[root@mastr-51 installer]#
....
. Specificare il binario di copia del file remoto da utilizzare da GPFS; utilizzare `-rc argument` .
+
....
...
[root@mastr-51 installer]#
....
. Specificare l'intervallo di porte da impostare su tutti i nodi GPFS; utilizzare `-e argument` .
+
....
...
[root@mastr-51 installer]#
....
. Visualizza le impostazioni di configurazione GPFS.
+
....
...
[root@mastr-51 installer]#
....
. Aggiungi un nodo di amministrazione.
+
....
...
[root@mastr-51 installer]#
....
. Verificare preventivamente le configurazioni prima dell'installazione.
+
....
...
....
. Controllare lo stato del disco NSD.
+
....
...
[root@mastr-51 cluster-test]#
....
. Controllare e fornire le autorizzazioni richieste al GPFS.
+
....
...
[root@mastr-51 cluster-test]#
....
. Controllare la lettura e la scrittura GPFS eseguendo il comando `dd` comando.
+
....
...
Per esportare GPFS in NFS, completare i seguenti passaggi:
...
[root@mastr-51 ~]#
....
. Elenca i file in GPFS per convalidare il client NFS.
+
....
...
. Installare i pacchetti nel client NFS.
+
....
...
[root@hdp2 ~]#
....
. Convalida l'elenco dei file GPFS nella cartella montata su NFS.
+
....
...
[root@hdp2 gpfstest]#
....
. Spostare i dati dall'NFS esportato da GPFS all'NFS NetApp utilizzando XCP.
+
....
