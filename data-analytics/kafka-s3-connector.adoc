...
summary: 'In questa configurazione, ti mostriamo come leggere e scrivere argomenti nell"archiviazione di oggetti da Kafka direttamente utilizzando il connettore sink Kafka s3.  Per questo test abbiamo utilizzato un cluster Confluent autonomo, ma questa configurazione è applicabile anche a un cluster distribuito.' 
---
...
root@stlrx2540m1-108:~#
....
. Per stampare i record, utilizzare avro-tools-1.11.0.1.jar (disponibile nel http://mirror.metrocast.net/apache/avro/stable/java/["Archivi Apache"^] ).
+
....
...
Instaclustr supporta i connettori Kafka Connect e i loro dettagli - link:https://github.com/instaclustr/kafka-connect-connectors["Maggiori dettagli"]. Instaclustr fornisce connettori aggiuntivi link:https://www.instaclustr.com/support/documentation/kafka-connect/bundled-kafka-connect-plugins/["i loro dettagli"]
