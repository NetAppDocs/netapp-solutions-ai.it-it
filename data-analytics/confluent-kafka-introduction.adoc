...
NetApp instaclustr supporta anche Kafka con storage a livelli dalla versione 3.8.1. Per maggiori dettagli, consultare qui link:https://www.instaclustr.com/support/documentation/kafka-add-ons/using-kafka-tiered-storage/["instaclust utilizzando l'archiviazione a livelli Kafka"]
