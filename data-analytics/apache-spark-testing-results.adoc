...
summary: Abbiamo utilizzato gli script TeraSort e TeraValidate nello strumento di benchmarking TeraGen per misurare la validazione delle prestazioni di Spark con le configurazioni E5760, E5724 e AFF-A800. 
---
= Risultati dei test
:hardbreaks:
:allow-uri-read: 
