...
| Networking | Connettività inter-cluster (se i cluster ONTAP sono separati) 
...
🔗 https://docs.netapp.com/us-en/trident/trident-install/kubernetes-deploy-operator.html["+++ Guida all'installazione Trident +++"]
...
| Prestazione | Convalida la latenza e la produttività per i carichi di lavoro di formazione 
|===
...
Visualizza i registri in https://console.union.ai["+++Interfaccia utente dell'Unione+++"]
